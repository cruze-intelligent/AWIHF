          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-3 mb-4 md:mb-6 text-white/80 text-sm md:text-base">
              <li className="flex items-start">
                ...
                <a href={`mailto:${organizationProfile.email}`} className="hover:text-brand-gold transition-colors">
              ...
              <li className="flex items-start">
                ...
                <span>{organizationProfile.postalAddress.poBox}, {organizationProfile.postalAddress.locality}</span>
              </li>
            </ul>

            <div className="flex space-x-3 md:space-x-4">
              <a href={organizationProfile.social.x} target="_blank" rel="noopener noreferrer" className="text-white hover:text-brand-gold transition-colors" aria-label="AWIHF on X">
                <Twitter className="w-5 h-5 md:w-6 md:h-6" />
              </a>
              <a href={organizationProfile.social.instagram} target="_blank" rel="noopener noreferrer" className="text-white hover:text-brand-gold transition-colors" aria-label="AWIHF on Instagram">
                <Instagram className="w-5 h-5 md:w-6 md:h-6" />
              </a>
              <a href={organizationProfile.social.linkedin} target="_blank" rel="noopener noreferrer" className="text-white hover:text-brand-gold transition-colors" aria-label="AWIHF on LinkedIn">
