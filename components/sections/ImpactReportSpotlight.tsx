  ...
  return (
    <section className="section-wrapper bg-white">
      <div className="content-container">
        <div className="rounded-2xl border border-brand-orange/20 bg-orange-tint/30 p-6 md:p-8 lg:p-10 grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-8 items-center">
          <div>
            ...
            <h2 className="text-[28px] md:text-[36px] font-bold text-brand-brown leading-tight mb-4">
              {report.title}
            </h2>
            <p className="text-[#111111] text-[17px] leading-[1.7] mb-6">{report.executiveSummary[0]}</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {report.stats.slice(0, 3).map((stat) => (
              <Card key={stat.label} className="bg-white p-5 border border-gray-200 shadow-sm">
                <div className="text-[30px] font-bold text-brand-orange mb-2">{stat.value}</div>
